        ...
        >
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5 mb-10 `}>
                    Those who sign up before we launch get unlimited access to
                    our services!
                </p>
            </div>
            <input
                className="w-full h-[50px] rounded-[20px] bg-discount-gradient text-white font-semibold px-4 py-2 max-w-[200px] mr-4"
                type="text"
            ...
            />
            <input
                className="w-full h-[50px] rounded-[20px] bg-discount-gradient text-white font-semibold px-4 py-2 mt-4 max-w-[200px] mr-4"
                type="text"
            ...
            />
            <input
                className="w-full h-[50px] rounded-[20px] bg-discount-gradient text-white font-semibold px-4 py-2 mt-4 mb-4 max-w-[400px] mr-4"
                type="email"
                placeholder="Email"
                value={email}
